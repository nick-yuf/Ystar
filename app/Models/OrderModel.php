...
class OrderModel extends BaseModel
{
    ...
    const source_1 = 1, source_2 = 2, source_3 = 3, source_4 = 4, source_5 = 5, source_6 = 6, source_7 = 7, source_8 = 8, source_9 = 9, source_10 = 10;
    const SourceArray = [
        self::source_1 => 'Face2',
        self::source_2 => 'Axon',
    ...
    public function getDataByPlatformOrderId($id,$limit)
    {
        return self::query()
            ->where(self::F_platform_order_id, $id)
            ->limit($limit)
            ->get();
    }
